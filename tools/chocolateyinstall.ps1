...
$url        = 'https://github.com/adventuregamestudio/ags/releases/download/v.3.4.3.1/AGS-3.4.3-P1.exe' # download url, HTTPS preferred
$url64      = 'https://github.com/adventuregamestudio/ags/releases/download/v.3.4.3.1/AGS-3.4.3-P1.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'Adventure Game Studio 3.4.3' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  #silentArgs   = '/S'           # NSIS
  silentArgs   = '/VERYSILENT /MERGETASKS="!desktopicon" /SUPPRESSMSGBOXES /NORESTART /SP-' # Inno Setup
